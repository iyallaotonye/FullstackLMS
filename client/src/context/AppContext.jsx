...
export const AppContextProvider = (props) => {
    ...
    const fetchAllCourses = async () => {
         try {
            await axios.get(backendUrl + '/api/courses/all')
            if(data.success){
    ...
    const fetchUserData = async ()=> {
        ...
        try {
            ...
            const {data} = await axios.get(backendUrl + '/api/users/data', {headers: {Authorization: `Bearer ${token}`}})
            if(data.success){
    ...
    const fetchUserEnrolledCourses = async () => {
        try {
            const token = await getToken()
            const {data} = await axios.get(backendUrl + '/api/courses/enrolled-courses', {
            headers: {
