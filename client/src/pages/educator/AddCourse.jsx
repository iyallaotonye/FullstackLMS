    ...
    justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        ...
        <div className='flex flex-col gap-1'>
          ...
          placeholder='0' min={0} max={100} className='outline-none md:py-2.5 py-2 w-28 
              ...
              <div className='flex justify-between items-center p-4 border-b'>
                <div className='flex items-center'>
                  <img onClick={() => handleChapter('toggle', chapter.chapterId)} 
                   src={assets.down_arrow_icon} width={14} alt="" 
              ...
              <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50'>
                <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
                  ...
                  <div className='mb-2'>
                    ...
                    value={lectureDetails.lectureTitle} onChange={(e) => setLectureDetails({
                  ...
                  <div className='mb-2'>
                    ...
                    value={lectureDetails.lectureDuration} onChange={(e) => setLectureDetails({
                  ...
                  <div className='mb-2'>
                    <p>Lecture URL</p>
                    <input type="text" className='mt-1 block w-full border rounded py-1 px-2'
                    value={lectureDetails.lectureUrl} onChange={(e) => setLectureDetails({
                  ...
                  <div className='flex gap-2 my-4'>
                    ...
                    value={lectureDetails.isPreviewFree} onChange={(e) => setLectureDetails({
