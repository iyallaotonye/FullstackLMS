...
const CourseDetails = () => {
  ...
  const {allCourses, calculateRating, 
    calculateChapterTime, calculateCourseDuration, calculateNoOfLectures, currency
  ...
  return courseData ? (
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
          ...
          <div className='flex'>
            ...
            src={i < Math.floor(calculateRating(courseData)) ? assets.star : assets.star_blank} alt='' className='w-3.5 h-3.5' />))}
          </div>
        ...
        <p className='text-sm'>Course by <span className='text-blue-600 underline'>Ngolo Kante</span></p>
            ...
            {courseData.courseContent.map((chapter, index) => (
              <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                ...
                onClick={() => toggleSection(index)}>
                  ...
                  <p className='text-sm md:text-[15px] md:leading-[21px]'>{chapter.chapterContent.length} lectures - {calculateChapterTime(chapter)}</p>
                </div>
                  ...
                  border-t border-gray-300'>
                    {chapter.chapterContent.map((lecture, i) => (
                      <li key={i} className='flex items-start gap-2 py-1'>
                        ...
                        text-xs md:text-[15px] md:leading-[21px]'>
      ...
      {/* Right column */}
      <div className='max-w-[424px] z-10 shadow-[0px 8px 32px 2px rgba(0,0,0,0.2)] rounded-t md:rounded-none
      overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
        ...
        <div className='pt-5'>
          ...
          <div className='pt-6'>
            ...
            <ul className='ml-4 pt-2 text-sm md:text-[15px] md:leading-[21px] text-gray-500 list-disc'>
