    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      <div className='flex flex-col md:flex-row items-start px-8 md:px-0 justify-center 
        ...
        <div className='flex flex-col md:items-start items-center w-full'>
          ...
          <p className='mt-6 text-center md:text-left text-sm text-white/80'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores fuga nihil laborum sapiente explicabo</p>
        </div>
        <div className='flex flex-col md:items-start items-center w-full'>
      ...
      <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 20205 c Glitters. All rights reserved.</p>
    </footer>
  )
}
